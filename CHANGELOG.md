...
This project follows [Semantic Versioning](https://semver.org/) once public version tags are published.
...
- PostgreSQL migrations, Docker Compose local runtime, and GitHub Actions CI.
